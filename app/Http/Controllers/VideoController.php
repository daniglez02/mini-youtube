...
class VideoController extends Controller
{
    ...
    {
        //Lista de todos los registros de la tabla sin where 
    ...
    {
        //Abre el formulario para capturar
    ...
    {
        //Almacena o guarda el registro nuevos
    ...
    {
        // Abre el formulario con un registro especifico
